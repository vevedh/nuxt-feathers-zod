...
features:
  ...
  - title: "Redis avec Nitro/Unstorage"
    details: "Ajoutez un cache Redis côté serveur avec TTL et invalidation explicite, sans exposer les secrets ni inventer une option NFZ absente de la 6.7.51."
