...
Il contient Nuxt 4 SPA, Quasar, UnoCSS, Pinia, Keycloak client-only, NFZ `6.7.37` remote direct, auto-sync LDAP après `keycloak.init()` et bouton de synchronisation manuel.
