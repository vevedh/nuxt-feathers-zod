...
Le **Builder Studio** est la surface de démonstration la plus importante pour comprendre NFZ. Depuis la version 6.5.38, ses lectures, prévisualisations et écritures passent par les services Feathers `nfz/*`. Les routes Nitro historiques ne servent plus que de compatibilité.
