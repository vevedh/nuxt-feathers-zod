...
- les commandes CLI avancées doivent être revalidées après tout patch touchant des templates ou de la génération TypeScript
...
- une capacité non documentée dans VitePress ne doit pas être présentée comme contractualisée dans le core OSS
...
- une doc alignée,
- et un parsing CLI stable sous Bun,
