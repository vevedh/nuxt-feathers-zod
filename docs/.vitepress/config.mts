    ...
    root: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: 'NFZ vs Supabase', link: '/guide/nfz-vs-supabase' },
                { text: 'Roadmap vNext', link: '/guide/roadmap-vnext' },
    ...
    en: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: 'NFZ vs Supabase', link: '/en/guide/nfz-vs-supabase' },
                { text: 'vNext roadmap', link: '/en/guide/roadmap-vnext' },
