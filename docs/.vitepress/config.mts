    ...
    root: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: 'App métier', link: '/guide/real-world-nuxt4-quasar-app' },
          { text: 'Référence', link: '/reference/' },
          { text: 'CLI', link: '/reference/cli' },
          { text: 'Auth locale', link: '/guide/auth-local' },
          { text: 'Keycloak SSO', link: '/guide/keycloak-sso' },
          { text: 'Keycloak + LDAP', link: '/guide/remote-keycloak-ldap' },
          { text: 'Keycloak LDAP SSR', link: '/guide/remote-keycloak-ldap-ssr' },
          ...
          '/guide/': [
            {
              ...
              items: withInternalGuide([
                ...
                { text: 'App métier Nuxt 4 + Quasar', link: '/guide/real-world-nuxt4-quasar-app' },
                { text: 'Migration app existante', link: '/guide/migrate-existing-nuxt4-app' },
                { text: 'Starter recommandé app métier', link: '/guide/starter-real-world-integration' },
                { text: 'Checklist intégration réelle', link: '/guide/real-world-integration-checklist' },
                ...
                { text: 'Auth session avec Pinia', link: '/guide/session-auth-pinia' },
                { text: 'Migration depuis Feathers-Pinia', link: '/guide/feathers-pinia' },
                ...
                { text: 'Remote Keycloak + LDAP/AD', link: '/guide/remote-keycloak-ldap' },
                { text: 'Remote Keycloak + LDAP/AD SSR', link: '/guide/remote-keycloak-ldap-ssr' },
          ...
          '/reference/': [
            {
              ...
              items: [
                ...
                { text: 'Événements et hooks', link: '/reference/events' },
    ...
    en: {
      ...
      themeConfig: {
        nav: [
          ...
          { text: 'Main starter', link: '/en/guide/starter-quasar-unocss-pinia' },
          { text: 'Real-world app', link: '/en/guide/real-world-nuxt4-quasar-app' },
          { text: 'Reference', link: '/en/reference/' },
          { text: 'CLI', link: '/en/reference/cli' },
          { text: 'Local auth', link: '/en/guide/auth-local' },
          { text: 'Keycloak SSO', link: '/en/guide/keycloak-sso' },
          { text: 'Keycloak + LDAP', link: '/en/guide/remote-keycloak-ldap' },
          { text: 'Keycloak LDAP SSR', link: '/en/guide/remote-keycloak-ldap-ssr' },
          ...
          '/en/guide/': [
            {
              ...
              items: withInternalGuide([
                ...
                { text: 'Production readiness', link: '/en/guide/production' },
                ...
                { text: 'Recommended real-world starter', link: '/en/guide/starter-real-world-integration' },
                { text: 'Real-world integration checklist', link: '/en/guide/real-world-integration-checklist' },
                { text: 'npm & Git publishing', link: '/en/guide/publishing' },
                { text: 'Community workflow', link: '/en/guide/community-workflow' },
                { text: 'Repository development flow', link: '/en/guide/repo-dev' },
                ...
                { text: 'Session auth with Pinia', link: '/en/guide/session-auth-pinia' },
                { text: 'Migrating from Feathers-Pinia', link: '/en/guide/feathers-pinia' },
                ...
                { text: 'Remote Keycloak + LDAP/AD', link: '/en/guide/remote-keycloak-ldap' },
                { text: 'Remote Keycloak + LDAP/AD SSR', link: '/en/guide/remote-keycloak-ldap-ssr' },
          ...
          '/en/reference/': [
            {
              ...
              items: [
                ...
                { text: 'Events and hooks', link: '/en/reference/events' },
