...
This page documents Feathers services scanned from `servicesDirs`, its configuration contract and the recommended usage pattern for application developers.
