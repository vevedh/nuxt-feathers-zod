...
It includes Nuxt 4 SPA, Quasar, UnoCSS, Pinia, client-only Keycloak, direct NFZ `6.7.45` remote mode, LDAP auto-sync after `keycloak.init()` and a manual synchronization button.
