...
> OSS reference snapshot: **v6.4.119** — optional Mongo management options aligned and release metadata synchronized.
...
Current OSS release target: **6.4.119**.
...
## CLI command surface in 6.4.119
