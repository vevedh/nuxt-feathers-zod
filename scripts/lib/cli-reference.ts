...
const frCommandNotes: Record<string, string> = {
  ...
  'add service': 'Génère un service Feathers avec adapter memory, MongoDB ou Knex, ou un service personnalisé.',
...
const enCommandNotes: Record<string, string> = {
  ...
  'add service': 'Generate a Feathers service using memory, MongoDB, Knex, or a custom service class.',
