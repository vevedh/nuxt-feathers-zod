...
const frCommandNotes: Record<string, string> = {
  ...
  'add service': 'Génère un service Feathers portable par moteur/connexion nommée, avec compatibilité adapter memory, MongoDB ou Knex.',
...
const enCommandNotes: Record<string, string> = {
  ...
  'add service': 'Generate a portable Feathers service by database engine/named connection, with memory, MongoDB, and Knex adapter compatibility.',
