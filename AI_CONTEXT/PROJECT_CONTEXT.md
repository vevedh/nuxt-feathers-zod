...
Added a real-world remote SSO bridge documentation patch:

- `strategy: 'keycloak-ldap'` is now the recommended explicit strategy name for Keycloak SSO + LDAP/AD resolution.
